    ...
    $.fn.utmzCustom = function (options) {
        ...
        * */
        ...
        if (get.hasOwnProperty('gclid')) {
          ...
          var referrer = get.referrer || document.referrer;
            /**
             * Traffic Sources
             */
            if ($.cookie('fxtmreferer') || referrer) {
                /**
                 * Is parameter set?
                 * documentReferrer
                 */
                // First check cookies, that created in geojs.php before redirecting to global/eu
                var referrerHostName = /*($.cookie('fxtmreferer') || */ _removeProtocol(referrer).replace('www.', '');
                ...
                if (searchSystem.known) {
                    ...
                    if (!isIgnored) {
                        var refHost = _parseUrl(referrer);
